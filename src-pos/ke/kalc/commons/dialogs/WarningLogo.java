...
public class WarningLogo extends JDialog {
    ...
    private void createPage() {
        ...
        imageLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ke/kalc/fixedimages/verkalclogo.png")));
        textLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ke/kalc/fixedimages/runningtext.png")));

        version.setText("V" + AppLocal.APP_VERSION + "       ");
        version.setForeground(new Color(29, 15, 191));

        version.setFont(KALCFonts.CHROMISFONTBOLD);
