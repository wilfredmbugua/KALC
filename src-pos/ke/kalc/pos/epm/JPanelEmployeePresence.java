...
import ke.kalc.pos.datalogic.DataLogicPresenceManagement;
...
import ke.kalc.pos.forms.BeanFactoryApp;
import ke.kalc.pos.forms.BeanFactoryException;
...
public class JPanelEmployeePresence extends javax.swing.JPanel implements JPanelView, BeanFactoryApp {
    ...
    public void init(AppView app) throws BeanFactoryException {
        this.app = app;
                dlpresencemanagement = (DataLogicPresenceManagement) app.getBean("ke.kalc.pos.datalogic.DataLogicPresenceManagement");
    }
    ...
    private void listBreaks()
    {
        try {
            ...
            java.util.List breaks = dlpresencemanagement.listBreaksVisible(dlpresencemanagement.getSiteGUID());
    ...
    private void initComponents() {
        ...
        btnCheckIn.setFont(KALCFonts.DEFAULTFONTBOLD.deriveFont(22f));
        ...
        btnCheckOut.setFont(KALCFonts.DEFAULTFONTBOLD.deriveFont(22f));
        ...
        jScrollPane1.setFont(KALCFonts.DEFAULTFONT.deriveFont(14f));
        jScrollPane1.setPreferredSize(new java.awt.Dimension(570, 120));

        message.setFont(KALCFonts.DEFAULTFONT);
