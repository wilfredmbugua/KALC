...
import ke.kalc.data.user.EditorRecord;
...
public final class PaymentsEditor extends javax.swing.JPanel implements EditorRecord {
    ...
    private void initComponents() {
        ...
        jTotal = new ke.kalc.editor.JEditorCurrency();
        m_jNotes = new ke.kalc.editor.JEditorString();
    ...
    private ke.kalc.editor.JEditorCurrency jTotal;
    private ke.kalc.editor.JEditorKeys m_jKeys;
    private ke.kalc.editor.JEditorString m_jNotes;
