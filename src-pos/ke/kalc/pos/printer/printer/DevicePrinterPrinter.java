...
import ke.kalc.pos.printer.ticket.BasicTicketForPrinter;
import ke.kalc.pos.util.ReportUtils;
import ke.kalc.pos.util.SelectPrinter;
 ...
 * class PrintableTicket @see ke.kalc.pos.printer.printer.PrintableTicket

 */
public class DevicePrinterPrinter implements DevicePrinter {

    private static final Logger logger = Logger.getLogger("ke.kalc.pos.printer.printer.DevicePrinterPrinter");
