...
public class SimpleReceipt extends javax.swing.JPanel {
    ...
    private void printTotals() {
        if (ticket.getLinesCount() == 0) {
            ...
            m_jTaxesEuros.setText(ticket.printTaxAmount());
    ...
    private void initComponents() {
        ...
        m_jTotalEuros.setFont(KALCFonts.DEFAULTFONT.deriveFont(14f));
        ...
        m_jLblTotalEuros1.setFont(KALCFonts.DEFAULTFONTBOLD.deriveFont(14f));
        ...
        m_jSubtotalEuros.setFont(KALCFonts.DEFAULTFONT.deriveFont(14f));
        ...
        m_jTaxesEuros.setFont(KALCFonts.DEFAULTFONT.deriveFont(14f));
        ...
        m_jLblTotalEuros2.setFont(KALCFonts.DEFAULTFONTBOLD.deriveFont(14f));
        ...
        m_jLblTotalEuros3.setFont(KALCFonts.DEFAULTFONTBOLD.deriveFont(14f));
        ...
        m_jTicketId.setFont(KALCFonts.DEFAULTFONT.deriveFont(14f));
