...
public class JProductLineEdit extends JDialog {
    ...
    private void showLineEditor() {
        ...
        m_jName.setEnabled(app.getAppUserView().getUser().hasPermission("uk.kalc.pos.sales.JPanelTicketEdits"));
        m_jPrice.setEnabled(app.getAppUserView().getUser().hasPermission("uk.kalc.pos.sales.JPanelTicketEdits"));
        m_jPriceTax.setEnabled(app.getAppUserView().getUser().hasPermission("uk.kalc.pos.sales.JPanelTicketEdits"));
