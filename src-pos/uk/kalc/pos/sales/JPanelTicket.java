...
import uk.kalc.pos.datalogic.DataLogicReceipts;
...
import uk.kalc.data.gui.*;
import uk.kalc.data.loader.SentenceList;
import uk.kalc.pos.customers.*;
import uk.kalc.pos.forms.*;
import uk.kalc.pos.inventory.TaxCategoryInfo;
import uk.kalc.pos.panels.JProductFinder;
import uk.kalc.pos.payment.*;
import uk.kalc.pos.printer.*;
import uk.kalc.pos.sales.restaurant.RestaurantDBUtils;
import uk.kalc.pos.scale.ScaleException;
import uk.kalc.pos.scripting.*;
import uk.kalc.pos.ticket.*;
...
import uk.kalc.pos.barcodes.Barcode;
import uk.kalc.commons.dialogs.JAlertPane;
import uk.kalc.commons.dialogs.Receipt;
import uk.kalc.commons.utils.KeyedData;
import uk.kalc.commons.utils.TerminalInfo;
import uk.kalc.pos.forms.JPrincipalApp;

import uk.kalc.pos.giftcards.GiftCardLogic;
import uk.kalc.pos.inventory.AlternativeBarcode;
import uk.kalc.pos.loyalty.*;
import uk.kalc.pos.payment.PaymentInfo;
import uk.kalc.pos.printer.DeviceDisplayAdvance;
import uk.kalc.pos.printer.IncludeFile;
import uk.kalc.pos.util.AutoLogoff;
import uk.kalc.globals.IconFactory;
import uk.kalc.pos.auditing.Audit;
...
// Create DataLogic instances currently required
        dlSystem = (DataLogicSystem) m_App.getBean("uk.kalc.pos.datalogic.DataLogicSystem");
        dlSales = (DataLogicSales) m_App.getBean("uk.kalc.pos.datalogic.DataLogicSales");
        dlCustomers = (DataLogicCustomers) m_App.getBean("uk.kalc.pos.datalogic.DataLogicCustomers");
        dlReceipts = (DataLogicReceipts) app.getBean("uk.kalc.pos.datalogic.DataLogicReceipts");
        ...
        if (cTrans == '\n') {
            if (m_sBarcode.length() == 0) {
                ...
                if (dlSystem.isFobPresent(barCode.toString())) {
                    stateToZero();
                    principalApp.showTask("uk.kalc.pos.panels.JPanelCloseMoney");
                    return;
                }
...
// test if there is valid ticket in the system at this till to be printed
    ...
    private void initComponents() {
        ...
        m_jNumberKey = new uk.kalc.beans.JNumberKeys();
        ...
        m_jNumberKey.addJNumberEventListener(new uk.kalc.beans.JNumberEventListener() {
            public void keyPerformed(uk.kalc.beans.JNumberEvent evt) {
    ...
    private void processKeypadEntry(uk.kalc.beans.JNumberEvent evt) {//GEN-FIRST:event_processKeypadEntry
    ...
    private void m_jKeyFactoryKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_m_jKeyFactoryKeyTyped
        mappedKeys.put("VK_F1", "class:uk.kalc.pos.sales.JPanelTicketEdits");
        mappedKeys.put("VK_F2", "class:uk.kalc.pos.customers.CustomersPayment");
        mappedKeys.put("VK_F3", "class:uk.kalc.pos.panels.JPanelPayments");
        mappedKeys.put("VK_F4", "class:uk.kalc.pos.panels.JPanelCloseMoney");
        mappedKeys.put("VK_F5", "action:btnCustomerAction");
        mappedKeys.put("VK_F6", "action:btnReprintAction");
        mappedKeys.put("VK_F7", "instance:uk.kalc.pos.sales.shared.JTicketsBagShared:newTicket:m_ticketsbag");
        mappedKeys.put("VK_F8", "instance:uk.kalc.pos.sales.shared.JTicketsBagShared:delTicketAction:m_ticketsbag");
        mappedKeys.put("VK_F9", "instance:uk.kalc.pos.sales.shared.JTicketsBagShared:selectLayaway:m_ticketsbag");
        mappedKeys.put("VK_F10", "instance:uk.kalc.pos.sales.JTicketsBag:deleteAllShared:m_ticketsbag");
        mappedKeys.put("VK_F11", "action:resetCache");
        mappedKeys.put("VK_F12", "instance:uk.kalc.pos.forms.JPrincipalApp:changePassword:principalApp");
        ...
        if (executionTask != null) {
            if (executionTask.startsWith("class:")) {
                ...
                try {
                    Method method = uk.kalc.pos.sales.JPanelTicket.class
    ...
    private uk.kalc.beans.JNumberKeys m_jNumberKey;
