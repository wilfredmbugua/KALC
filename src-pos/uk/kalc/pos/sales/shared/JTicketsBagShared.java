...
**
 */
package uk.kalc.pos.sales.shared;
...
import uk.kalc.pos.sales.CustomerDisplay;
...
public class JTicketsBagShared extends JTicketsBag {
    ...
    public void activate() {
        m_sCurrentTicket = null;
        selectValidTicket();
        m_jDelTicket.setEnabled(AppUser.hasPermission("uk.kalc.pos.sales.JPanelTicketEdits"));
        checkLayaways();
    }
