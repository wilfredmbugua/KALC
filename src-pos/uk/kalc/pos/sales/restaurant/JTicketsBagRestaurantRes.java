...
import uk.kalc.beans.DateUtils;
import uk.kalc.beans.JCalendarPanel;
import uk.kalc.beans.JTimePanel;
...
import uk.kalc.data.user.EditorCreator;
...
public class JTicketsBagRestaurantRes extends javax.swing.JPanel {
    ...
    public JTicketsBagRestaurantRes(AppView oApp, JTicketsBagRestaurantMap restaurantmap) {
        ...
        dlCustomers = (DataLogicCustomers) oApp.getBean("uk.kalc.pos.datalogic.DataLogicCustomers");
