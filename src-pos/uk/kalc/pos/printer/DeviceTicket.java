...
import uk.kalc.pos.forms.AppProperties;
import uk.kalc.pos.printer.escpos.CodesEpson;
import uk.kalc.pos.printer.escpos.CodesIthaca;
import uk.kalc.pos.printer.escpos.CodesStar;
import uk.kalc.pos.printer.escpos.CodesSurePOS;
import uk.kalc.pos.printer.escpos.CodesTMU220;
import uk.kalc.pos.printer.escpos.DeviceDisplayESCPOS;
import uk.kalc.pos.printer.escpos.DeviceDisplaySurePOS;
import uk.kalc.pos.printer.escpos.DevicePrinterESCPOS;
import uk.kalc.pos.printer.escpos.DevicePrinterPlain;
import uk.kalc.pos.printer.escpos.PrinterWritter;
import uk.kalc.pos.printer.escpos.PrinterWritterFile;
import uk.kalc.pos.printer.escpos.PrinterWritterRXTX;
import uk.kalc.pos.printer.escpos.PrinterWritterRaw;
import uk.kalc.pos.printer.escpos.UnicodeTranslatorEur;
import uk.kalc.pos.printer.escpos.UnicodeTranslatorInt;
import uk.kalc.pos.printer.escpos.UnicodeTranslatorStar;
import uk.kalc.pos.printer.escpos.UnicodeTranslatorSurePOS;
import uk.kalc.pos.printer.javapos.DeviceDisplayJavaPOS;
import uk.kalc.pos.printer.javapos.DeviceFiscalPrinterJavaPOS;
import uk.kalc.pos.printer.javapos.DevicePrinterJavaPOS;
import uk.kalc.pos.printer.printer.DevicePrinterPrinter;
import uk.kalc.pos.printer.screen.DeviceDisplayScreen;
import uk.kalc.pos.printer.screen.DeviceDisplayWindow;
import uk.kalc.pos.printer.screen.DevicePrinterPanel;
import uk.kalc.pos.util.StringParser;
...
public class DeviceTicket {
    ...
    private static final Logger logger = Logger.getLogger("uk.kalc.pos.printer.DeviceTicket");
