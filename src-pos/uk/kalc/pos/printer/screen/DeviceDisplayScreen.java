...
package uk.kalc.pos.printer.screen;
...
public class DeviceDisplayScreen extends javax.swing.JFrame implements DeviceDisplay, DeviceDisplayAdvance {
    ...
    /**
     * Creates new form DeviceDisplayWindow FanZam FullScreen version Layout
     * 01/03/16
     */
    public DeviceDisplayScreen() {
    ...
    public void setDisplayIdentity(int display){
