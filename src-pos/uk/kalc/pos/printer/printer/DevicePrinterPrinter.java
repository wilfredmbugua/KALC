...
package uk.kalc.pos.printer.printer;
...
import uk.kalc.pos.printer.ticket.BasicTicket;
import uk.kalc.pos.printer.ticket.BasicTicketForPrinter;
import uk.kalc.pos.util.ReportUtils;
import uk.kalc.pos.util.SelectPrinter;
 ...
 * printer or not. 
 * <p>For receipt printers length of a receipt must be calculated in this class.</p>
 * <p>For normal printers number of pages must be calculated dynamically in the <br>
 * class PrintableTicket @see uk.kalc.pos.printer.printer.PrintableTicket

 */
public class DevicePrinterPrinter implements DevicePrinter {

    private static final Logger logger = Logger.getLogger("uk.kalc.pos.printer.printer.DevicePrinterPrinter");
