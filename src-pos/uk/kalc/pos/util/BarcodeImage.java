...
public class BarcodeImage {
    ...
    public static BufferedImage getBarcodeCode39Image(String value) {
        AbstractBarcodeBean barcode = new Code39Bean();
        barcode.setMsgPosition(HumanReadablePlacement.HRP_BOTTOM);
        return getBarcodeBI(value, barcode);
    }
    ...
    private static BufferedImage getBarcodeBI(String value, AbstractBarcodeBean barcode) {
    ...
    private static class GetBarImage {
        ...
        private BufferedImage getImage() {
            ...
            try {
                imgtext = ImageIO.read(getClass().getResourceAsStream("/uk/kalc/fixedimages/invalid1.png"));
