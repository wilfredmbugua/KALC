...
import uk.kalc.pos.payment.JPaymentSelect;
import uk.kalc.pos.payment.JPaymentSelectCustomer;
...
public class CustomersPayment extends JDialog {
    ...
    public CustomersPayment(AppView app) {
        ...
        this.app = app;
        dlCustomers = (DataLogicCustomers) app.getBean("uk.kalc.pos.datalogic.DataLogicCustomers");
