...
**
**    Copyright (c) 2015-2022 KALC Corporation   
**
...
public class JNumberKeys extends javax.swing.JPanel {
    ...
    private List synchList = Collections.synchronizedList(m_Listeners);
    ...
    public void dotIs00(boolean enabled) {
        if (enabled) {
            m_jKeyDot.setIcon(IconFactory.getIcon("btn00.png"));
        }
    }
    ...
    private class MyKeyNumberListener implements java.awt.event.ActionListener {
        ...
        public void actionPerformed(java.awt.event.ActionEvent evt) {
            ...
            while (synchList.size() > j) {
                oListener = (JNumberEventListener) synchList.get(j);
    ...
    private void initComponents() {
        ...
        m_jCE.setIcon(IconFactory.getIcon("btnce.png"));
        ...
        m_jMultiply.setIcon(IconFactory.getIcon("btnmult.png"));
        ...
        m_jMinus.setIcon(IconFactory.getIcon("btnminus.png"));
        ...
        m_jPlus.setIcon(IconFactory.getIcon("btnplus.png"));
        ...
        m_jKey9.setIcon(IconFactory.getIcon("btn9.png"));
        ...
        m_jKey8.setIcon(IconFactory.getIcon("btn8.png"));
        ...
        m_jKey7.setIcon(IconFactory.getIcon("btn7.png"));
        ...
        m_jKey4.setIcon(IconFactory.getIcon("btn4.png"));
        ...
        m_jKey5.setIcon(IconFactory.getIcon("btn5.png"));
        ...
        m_jKey6.setIcon(IconFactory.getIcon("btn6.png"));
        ...
        m_jKey3.setIcon(IconFactory.getIcon("btn3.png"));
        ...
        m_jKey2.setIcon(IconFactory.getIcon("btn2.png"));
        ...
        m_jKey1.setIcon(IconFactory.getIcon("btn1.png"));
        ...
        m_jKey0.setIcon(IconFactory.getIcon("btn0.png"));
        ...
        m_jKeyDot.setIcon(IconFactory.getIcon("btndot.png"));
        ...
        m_jEquals.setIcon(IconFactory.getIcon("btnequals.png"));
