...
import static uk.kalc.globals.SystemProperty.USERCOUNTRY;
import static uk.kalc.globals.SystemProperty.USERLANGUAGE;
...
public abstract class Formats {
    ...
    public final static Formats DECIMAL = new FormatsDECIMAL();
    public final static Formats CURRENCY = new FormatsCURRENCY();
    public final static Formats CURRENCYNS = new FormatsCURRENCYNS();
    ...
    private static NumberFormat m_decimalformat = new DecimalFormat("#0.00");
    ...
    private static final DateFormat hourminformat = new SimpleDateFormat("H:mm");
    ...
    public static void setDecimalPattern(String pattern) {
        if (pattern == null || pattern.equals("")) {
            m_decimalformat = new DecimalFormat("#.00");
        } else {
    ...
    public static void setCurrencyPattern(String pattern) {
        if (pattern == null || pattern.equals("")) {
            m_currencyformat = NumberFormat.getCurrencyInstance(new Locale(USERLANGUAGE, USERCOUNTRY));
        } else {
    ...
    private static final class FormatsDECIMAL extends Formats {

        @Override
        protected String formatValueInt(Object value) {
            return m_decimalformat.format((Number) value);
    ...
    private static final class FormatsCURRENCYNS extends Formats {

        @Override
        protected String formatValueInt(Object value) {
            String tmp = m_currencyformat.format(DoubleUtils.fixDecimals((Number) value));

            return m_currencyformat.format(DoubleUtils.fixDecimals((Number) value)).replaceAll(regex, "");
        }
    ...
    private static final class FormatsHOURMIN extends Formats {
        ...
        @Override
        protected String formatValueInt(Object value) {
            return hourminformat.format(value);
        }

        @Override
        protected Date parseValueInt(String value) throws ParseException {
            return hourminformat.parse(value);
        }
