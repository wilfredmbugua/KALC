...
public class JCalendarDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        setTitle(AppLocal.getIntString("title.calendar")); // NOI18N
        setResizable(false);
        ...
        jcmdOK.setIcon(IconFactory.getIcon("ok.png"));
        ...
        jcmdCancel.setFont(ChromisFonts.DEFAULTBUTTONFONT);
        jcmdCancel.setIcon(IconFactory.getIcon("cancel.png"));
        ...
        jPanelGrid.setFont(ChromisFonts.DEFAULTFONT.deriveFont(14f)
        );
