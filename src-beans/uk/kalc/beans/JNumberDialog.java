...
public class JNumberDialog extends javax.swing.JDialog {
    ...
    public static Double showEditNumber(Component parent, String title, String message, Icon icon) {
        ...
        myMsg.setSize(new Dimension (240,470));
    ...
    private void initComponents() {
        ...
        m_jnumber = new uk.kalc.editor.JEditorDoublePositive();
        ...
        m_jnumber.setFont(ChromisFonts.DEFAULTFONT.deriveFont(14f)
        );
        ...
        setSize(new java.awt.Dimension(253, 453));
    ...
    private uk.kalc.editor.JEditorDoublePositive m_jnumber;
