...
public class JSaver extends JPanel implements StateListener {
    ...
    private void initComponents() {
        ...
        jbtnNew.setIcon(IconFactory.getIcon("editnew.png"));
        ...
        jbtnDelete.setIcon(IconFactory.getIcon("sale_delete.png"));
        ...
        jbtnSave.setIcon(IconFactory.getIcon("filesave.png"));
    ...
    private void jbtnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnSaveActionPerformed
        try {
            ...
            MessageInf msg = new MessageInf(MessageInf.SGN_NOTICE, AppLocal.getIntString("message.nosave"), eD);
            msg.show(this);
        }
    ...
    private void jbtnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnDeleteActionPerformed
        try {
            ...
            MessageInf msg = new MessageInf(MessageInf.SGN_NOTICE, AppLocal.getIntString("message.nodelete"), eD);
            msg.show(this);
            m_bd.resetDirty();
            try {
                m_bd.refreshData();
            } catch (BasicException ex) {
                Logger.getLogger(JSaver.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    private void jbtnNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnNewActionPerformed
        try {
            ...
            MessageInf msg = new MessageInf(MessageInf.SGN_NOTICE, AppLocal.getIntString("message.nonew"), eD);
            msg.show(this);
        }
