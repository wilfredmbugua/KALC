...
public class JMessageDialog extends javax.swing.JDialog {
    ...
    public static void showMessage(Component parent, MessageInf inf) {
        ...
        myMsg.setTitle(AppLocal.getIntString("title.message") + " - " + AppLocal.APP_VERSION);   
    ...
    private void initComponents() {
        ...
        setTitle(AppLocal.getIntString("title.dbmessage")); // NOI18N
        setResizable(false);
        ...
        jlblMessage.setFont(ChromisFonts.DEFAULTFONT.deriveFont(14f)
        );
        ...
        jcmdOK.setFont(ChromisFonts.DEFAULTBUTTONFONT);
        ...
        jcmdMore.setFont(ChromisFonts.DEFAULTBUTTONFONT);
        jcmdMore.setText(AppLocal.getIntString("button.information")); // NOI18N
        ...
        setSize(new java.awt.Dimension(455, 171));
